    ...
    <div id="container">
        ...
        <div class="pagetabs">
            <ul class="m4">
                ...
                <li><a href="${cp}/doyoon/inquiry.jsp">문의사항</a></li>
                <li><a href="${cp}/geunseok/board_event.jsp">이벤트</a></li>
        ...
        <div class="inquiry">
            <form action="${cp}/inquiry/InquiryWriteOk.mo" name="inquiryForm" method="post" onsubmit="return sendit()" enctype="multipart/form-data">
                <div class="contactus">
                    <h4>CONTACT US</h4>
                    <div class="formarea">
                        <div class="fl">
                            <div class="inbox">
                                <div id="select_box">
                                    ...
                                    <select name="form1" id="sel" class="form1">
                            ...
                            <div class="inputbox">
                                <input type="text" id="form2" name="username">
                                <label>*이름</label>
                            </div>
                            <div class="inputbox">
                                <input type="text" id="form3" name="email">
                                <label>*이메일</label>
                            </div>
                            <div class="inputbox">
                                <input type="text" id="form4" name="userphn">
                                <label>연락처</label>
                            </div>
                            <div class="inputbox">
                                <input type="text" id="form5" name="title">
                                <label>*제목</label>
                            </div>
                            <div class="inputbox">
                                <textarea name="content" id="form6"></textarea>
                                <label>*내용</label>
                            </div>
                            <div class="filebox">
...
<script>
	function sendit(){
		...
		const inquirytitle = boardForm.inquirytitle;
		if(inquirytitle.value == ""){
			alert("제목을 입력하세요!");
			inquirytitle.focus();
			return false;
		}
		const inquirycontents = inquiryForm.inquirycontents;
		if(inquirycontents.value == ""){
			alert("내용을 입력하세요!");
			inquirycontents.focus();
			return false;
		}
		inquiryForm.submit();
	}
