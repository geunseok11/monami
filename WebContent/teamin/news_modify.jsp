			...
			<div class="Write">
				...
				<input type="hidden" name="news_idx" value="${board.news_idx}">
					...
					<table border="1" style="border-collapse: collapse">
						...
						<tr class="v1">
							<th>동영상첨부</th>
							<td><label for="file2" class="filelabel2">첨부파일</label><input
...
function sendit() {
	...
	const news_subtit = newsForm.news_subtit;
	if (news_subtit.value == "") {
		alert("서브제목을 입력하세요!");
		news_subtit.focus();
		return false;
	}
	const news_content = newsForm.news_content;
