    ...
    <div id="container">
        ...
        <div class="pagetabs">
            <ul class="m4">
                ...
                <li><a href="./Inquiry.jsp" class="on">문의하기</a></li>
                <li><a href="../geunseok/board_event.jsp">이벤트</a></li>
                <li><a href="../shop/shop.jsp">모나미 패밀리샵 찾기</a></li>
            </ul>
        </div>
        <h3 class="title1">
        ...
        <div class="inquiry">
            <form action="iqr_db.jsp" name="iqr_frm" method="post" onsubmit="return sendit()">
                <div class="contactus">
                    <h4>CONTACT US</h4>
                    <div class="formarea">
                        <div class="fl">
...
개인정보취급방침 시행일자 : 2018년 08월 02일 
                    ...
                    <div class="btn_send">
                        <!-- <a onclick="request_check();">SEND</a> -->
